...
//        Toast.makeText(context, "NumCorrect: ${args.numCorrect}, NumQuestions: ${args.numQuestions}", Toast.LENGTH_LONG).show()
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        // check if activity resolves. The app will crash if you try to open a sharing intent with no ailable option for that mime type.
        // so, we use the packagemanager to check if the intent will resolve properly and hide the menu if it will not resolve
